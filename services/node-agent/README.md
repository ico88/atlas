...
The agent registers on startup and then heartbeats forever. If the control
plane forgets the node (404 on heartbeat), it re-registers automatically. The
node appears in the UI **System Status / Nodes** page and in
`GET /api/v1/nodes`.
